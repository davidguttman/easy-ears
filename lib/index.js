...
(function() {
  ...
  EasyEars = (function() {
    ...
    EasyEars.prototype.updateMaxMinFreqs = function() {
      var curGroupMax, curGroupMin, curMax, curMin, _ref, _ref1, _ref2, _ref3;

      curMax = max(this.boostedFreqs);
      if ((_ref = this.freqMax) == null) {
        this.freqMax = curMax;
      }
